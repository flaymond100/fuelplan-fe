        ...
        <aside className="hidden flex-col justify-between p-12 lg:flex">
          ...
          <div className="max-w-md">
            ...
            <p className="mt-6 text-zinc-400">
              Personalised nutrition plans built around your route, your body, and your gut.
              Your first plan is on us.
            </p>

            <ul className="mt-10 space-y-4 text-sm text-zinc-300">
              <Bullet>Reads your GPX — elevation, distance, time</Bullet>
              <Bullet>Tuned to your weight, pace, and gut tolerance</Bullet>
              <Bullet>Hour-by-hour plan you can print or save offline</Bullet>
            </ul>
          </div>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                  ...
                  <p className="text-center text-xs text-zinc-500">
                    ...
                    <a href="#" className="text-zinc-400 underline-offset-2 hover:underline">Terms</a>{' '}
                    and{' '}
                    <a href="#" className="text-zinc-400 underline-offset-2 hover:underline">Privacy Policy</a>.
                  </p>
                </form>
              </>
            )}
...
function CheckEmail({ email }: { email: string }) {
  return (
    <div className="text-center">
      <div className="mx-auto grid h-14 w-14 place-items-center rounded-sm bg-linear-to-br from-brand-400/20 to-brand-600/10 text-brand-300 ring-1 ring-inset ring-brand-500/30">
      ...
      <p className="mt-3 text-zinc-400">
        We sent a confirmation link to <span className="font-medium text-zinc-200">{email}</span>.
        Click it to activate your account.
      </p>
      <p className="mt-6 text-sm text-zinc-500">
        Didn't get it? Check your spam folder, or{' '}
        <Link to="/signup" className="text-brand-400 hover:text-brand-300">try again</Link>.
      </p>
      <Link
        to="/"
        className="mt-10 inline-flex items-center gap-2 text-sm font-medium text-zinc-400 transition hover:text-zinc-200"
      >
